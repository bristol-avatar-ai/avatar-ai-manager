...
private const val TAG = "PathsAtAnchorListFragment"

class PathsAtAnchorListFragment : ListFragment<PathWithNames>() {

    private val args: PathsAtAnchorListFragmentArgs by navArgs()

    private val addPath = {
        saveScrollPositionAndNavigate(
            PathsAtAnchorListFragmentDirections.actionPathsAtAnchorListFragmentToAddPathFragment(
                args.originId,
                args.originName,
                null,
                null,
    ...
    private val editPath = { path: PathWithNames ->
        saveScrollPositionAndNavigate(
            PathsAtAnchorListFragmentDirections.actionPathsAtAnchorListFragmentToEditPathFragment(
                args.originId,
                args.originName,
